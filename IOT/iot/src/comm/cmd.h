...
const std::string CMD_LOGOUT = "um_logout";                                                             //退出客户端
...
//同步服务器
const std::string CMD_SYN_REQ = "syn_req";                                                              //数据同步请求
const std::string CMD_SYN_RSP = "syn_rsp";                                                              //数据同步响应
const std::string CMD_SYN_REGISTER = "syn_register";                                                    //注册路由器ID
const std::string CMD_SYN_UNREGISTER = "syn_unregister";                                                //去注册路由器ID
