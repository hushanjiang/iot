...
// 用户状态
const std::string US_LOGIN = "login";            //登录
const std::string US_OFFLINE = "offline";        //离线
const std::string US_LOGOUT = "logout";          //退出
...
{
	DM_DEVICE_CATEGORY_MASTER_SWITCH		= -1,	// 总开关
	DM_DEVICE_CATEGORY_HOUSE_ALL_LIGHT		= -2,	// 全屋灯
	...
	DM_DEVICE_CATEGORY_INTELLIGENT_SPEAKER	= 15,	// 可视对讲机
