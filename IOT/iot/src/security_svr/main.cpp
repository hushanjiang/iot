...
int main(int argc, char * argv[])
{
	...
	XCP_LOGGER_INFO(&g_logger, "        prepare to start Security Svr! ...\n");
	XCP_LOGGER_INFO(&g_logger, "=============================================\n");
	...
	//(11) 完成Security Svr  的启动
	XCP_LOGGER_INFO(&g_logger, "===== complete to start Security Svr! =====\n");
