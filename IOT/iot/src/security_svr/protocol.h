...
public:
	...
	static int create_security_channel_req(const std::string &req, std::string &id, std::string &key, std::string &err_info);

	static int refresh_security_channel_req(const std::string &req, std::string &id, std::string &err_info);	
