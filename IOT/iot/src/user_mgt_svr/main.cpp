...
int main(int argc, char * argv[])
{
	...
	XCP_LOGGER_INFO(&g_logger, "        prepare to start User Mgt Svr! ...\n");
	XCP_LOGGER_INFO(&g_logger, "=============================================\n");
	...
	//(10) 完成User Mgt Svr  的启动
	XCP_LOGGER_INFO(&g_logger, "===== complete to start User Mgt Svr! =====\n");
