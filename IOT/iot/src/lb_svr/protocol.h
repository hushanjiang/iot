...
public:
	...
	static int worker_info(const std::string &req, std::string &worker_id, std::string &ip, unsigned short &port, std::string &err_info);
	
	static int hb_req(const std::string &req, unsigned int &client_num, std::string &err_info);
	
	static std::string lb_rsp(const std::string &ip, const unsigned short port);
